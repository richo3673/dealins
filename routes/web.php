...
Route::get('/{id}/edit', [MainController::class, 'edit'])->middleware(['auth'])->name('edit-form');
Route::get('/create', [MainController::class, 'create'])->middleware(['auth'])->name('create-form');
Route::post('/{id}/update', [MainController::class, 'update'])->middleware(['auth'])->name('update');
